...
data_ip="https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip"
izin_scripted() {
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[41;1;97m                    LUNATIC TUNNELING                    ${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
# REPOSITORY    
    REPO="https://raw.githubusercontent.com/LunaticTunnel/ZZxxLTxxZZ/master/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/LunaticTunnel/izin/master/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://wa.me/6282240074362"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6282240074362"}]]}'
...
wget raw.githubusercontent.com/LunaticTunnel/ZZxxLTxxZZ/master/files/limit.sh && chmod +x limit.sh && ./limit.sh
...
echo -e ""
echo -e "\033[93mwait 3 sec.....\033[0m"
sleep 3
echo ""
